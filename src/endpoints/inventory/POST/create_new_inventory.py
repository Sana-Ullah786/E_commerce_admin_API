...
async def create_inventory(inventory: InventorySchema, db: Session = Depends(get_db)) -> JSONResponse:
    ...
    return JSONResponse(
        ...
        content={"message": "Inventory created successfully", "inventory_id": new_inventory.inventory_id},
    )